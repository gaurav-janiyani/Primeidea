...
const KeyComponentsOfFinancialPlanning = () => {
  ...
  return (
    <section>
      <div className="py-8 bg-[#293C7D]">
        <div className="max-w-[1320px] mx-auto px-2">
          <h2 className="text-3xl text-white mb-6 text-center font-medium">
            Key Components for Financial Planning
          </h2>
          <ul className="flex justify-between mb-5">
            <li className="w-1/2 text-2xl px-4 py-4 text-center text-white border-b border-b-[#fff] cursor-pointer" onClick={() => handleTabClick(0)}>
              Budgeting
            </li>
            <li className="w-1/2 text-2xl px-4 py-4 text-center text-white border-b border-b-[#fff] cursor-pointer" onClick={() => handleTabClick(1)}>
              Savings Strategies
            </li>
            <li className="w-1/2 text-2xl px-4 py-4 text-center text-white border-b border-b-[#fff] cursor-pointer" onClick={() => handleTabClick(2)}>
              Investment Basics
            </li>
            <li className="w-1/2 text-2xl px-4 py-4 text-center text-white border-b border-b-[#fff] cursor-pointer" onClick={() => handleTabClick(3)}>
              Risk Management
            </li>
          </ul>
          <div className={`border border-[#717171] rounded-xl bg-[#479AD2] ${activeTab === 0 ? 'block' : 'hidden'}`}>
          ...
          <div className={`border border-[#717171] rounded-xl bg-[#479AD2] ${activeTab === 1 ? 'block' : 'hidden'}`}></div>
          <div className={`border border-[#717171] rounded-xl bg-[#479AD2] ${activeTab === 2 ? 'block' : 'hidden'}`}></div>
          <div className={`border border-[#717171] rounded-xl bg-[#479AD2] ${activeTab === 3 ? 'block' : 'hidden'}`}></div>
        </div>
      </div>
    </section>
  );
