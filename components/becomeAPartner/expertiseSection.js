...
const ExpertiseSection = () => {
  return (
    <section>
      <div className="pt-16 2xl:pt-40 pb-16 lg:pb-0  mx-auto bg-[url('/images/icons/p-vector.png')] bg-no-repeat bg-[center_top_13%] lg:bg-left-bottom">        
        <div className="max-w-[1150px] mx-auto px-2">
          <div className="flex justify-between items-center flex-col lg:flex-row mx-[-15px]">
            ...
            <FadeUpOneByOneAnimation className="w-full md:w-[70%] lg:w-1/2 px-[30px] md:px-[15px] xl:pl-8">
              <h2 className="text-[32px] md:text-[36px] leading-[120%] font-medium mb-3 text-black">
