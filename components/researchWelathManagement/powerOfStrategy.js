    ...
    <section>
      ...
      <div className="relative">
        <Image
          ...
          className="w-full min-h-[580px] object-cover"
        />
        <div className="absolute top-0 left-0 w-full h-[62%] bg-gradient-to-b from-[#000] to-[#00000000]"></div>
        <div className="absolute top-0 left-[50%] translate-x-[-50%] w-full max-w-[750px] pt-14 px-4 xl:px-0">
            <h2 className="text-white text-center mb-6 leading-[130%] text-[28px] xl:text-3xl font-medium">
              <FadeUpOneByOneAnimation> 
                The Power Behind Our Strategies
              </FadeUpOneByOneAnimation>
            </h2>
            <FadeUpOneByOneAnimation> 
              <p className="text-white text-center text-lg lg:text-xl mb-3">
